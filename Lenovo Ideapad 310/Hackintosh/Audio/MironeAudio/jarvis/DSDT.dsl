 ...
 *
 * Disassembly of /var/folders/k8/hndwz7f952z1fhhj3gwdr40r0000gn/T/BD18CF86-A7CB-4B5D-9956-B1A0D669A833-406-0000002D95A9A774/DSDT.aml, Sat Jul 22 20:38:17 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001BF42 (114498)
 *     Revision         0x02
 *     Checksum         0x4F
 *     OEM ID           "Apple "
 *     OEM Table ID     "CB-01   "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "Apple ", "CB-01   ", 0x00000001)
{
    /*
     * iASL Warning: There were 31 external control methods found during
     * disassembly, but only 27 were resolved (4 unresolved). Additional
    ...
    External (IR3E, UnknownObj)    // Warning: Unknown object
    ...
    External (RAID, UnknownObj)    // Warning: Unknown object
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x7CE4F018, 0x06A0)
    ...
    OperationRegion (OGNS, SystemMemory, 0x7CE4FFD8, 0x0000000C)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (EC0)
        {
            ...
            Scope (\)
            {
                OperationRegion (LFCN, SystemMemory, 0x7C78DE58, 0x00E8)
    ...
    OperationRegion (MDBG, SystemMemory, 0x7CE39018, 0x00001004)
